		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '[❗] Este comando só pode ser usado pelo grupo proprietário!(mateu😌) ❌',
					ownerB: '[❗] Este comando só pode ser usado pelo mateu! ❌',
